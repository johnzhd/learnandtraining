 ...
 */
typedef struct GumboSourcePosition{
  unsigned int line;
  unsigned int column;
  unsigned int offset;
} GumboSourcePosition;
 ...
 */
typedef struct GumboStringPiece{
 ...
 */
typedef enum GumboAttributeNamespaceEnum{
...
typedef enum GumboQuirksModeEnum{
 ...
 */
typedef enum GumboNamespaceEnum{
